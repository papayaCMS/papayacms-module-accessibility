...
* @version $Id: actbox_pagezoom_links.php 39592 2014-03-17 15:43:33Z weinert $
*/
  ...
  */
  function getParsedData() {
    ...
    if (isset($GLOBALS['PAPAYA_PAGE']) && is_object($GLOBALS['PAPAYA_PAGE'])) {
      ...
      $currentZoom = $page->getPageOption('pagezoom');
      if (isset($_GET['zoom'])) {
        ...
        if ($newZoom != $currentZoom) {
          $page->setPageOption('pagezoom', $newZoom);
          $currentZoom = $newZoom;
        }
      } else {
  ...
  */
  function getCacheId() {
    ...
    if (isset($_GET['zoom'])) {
      ...
      /** @var papaya_page $page */
      $page = $GLOBALS['PAPAYA_PAGE'];
      $cacheIdent .= 'zoom='.round($page->getPageOption('pagezoom') * 10000);
    }
